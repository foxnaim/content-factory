...
export default async function QueuePage() {
  ...
  return <div className="space-y-6"><header><div className="eyebrow">Live studio</div><h1 className="mt-3 text-4xl font-black">What is being made</h1><p className="mt-2 text-slate-400">Follow every draft from script to final review.</p></header>
